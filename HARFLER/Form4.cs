...
namespace HARFLER
{
    public partial class Form4 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'harflerDataSet3.TEKLI' table. You can move, or remove it, as needed.
            this.tEKLITableAdapter1.Fill(this.harflerDataSet3.TEKLI);
            // TODO: This line of code loads data into the 'harflerDataSet2.TEKLI' table. You can move, or remove it, as needed.
            this.tEKLITableAdapter.Fill(this.harflerDataSet2.TEKLI);
        ...
        {
            //girdimiz ab olsun a yi, sonra b  yi işleyeceği için döngüsayısı Length oldu 
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmdText = "UPDATE TEKLI SET OLASILIK = 0";
                mng.ExecuteNonQuery(CommandType.Text, cmdText);
